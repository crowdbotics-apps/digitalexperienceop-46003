"""
Django settings for digitalexperienceop_46003 project.
...
ROOT_URLCONF = 'digitalexperienceop_46003.urls'
...
WSGI_APPLICATION = 'digitalexperienceop_46003.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "digitalexperienceop_46003 API",
    "DESCRIPTION": "API documentation for digitalexperienceop_46003 App",
    "VERSION": "v1",
}
